 ...
 */
@Entity
@Table(name = "cd_lSecurityQuestion")
public class CdLSecurityQuestionEntity {
    ...
    public boolean equals(Object o) {
        ...
        CdLSecurityQuestionEntity that = (CdLSecurityQuestionEntity) o;

        if (id != null ? !id.equals(that.id) : that.id != null) {
            return false;
        }
        if (l10N != null ? !l10N.equals(that.l10N) : that.l10N != null) {
            return false;
        }
